   ...
   private IEnumerator Start()
    {
        if (GameManager.CurrentRun == 0)
        {
            ...
            DialogueManager.PushDialogue("Welcome in our small store. Here you can find how to upgrade your ship. On the upper left, you can find new weapons to add to your arsenal!", DialogueParts.Player);
            while (DialogueManager._blockDialoguePrinting) yield return new WaitForSeconds(Time.deltaTime);
